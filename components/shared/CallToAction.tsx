  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="w-full h-screen px-4 py-10 sm:p-10 md:px-20 max-w-xl lg:max-w-5xl 2xl:max-w-7xl mx-auto flex flex-col justify-center">
        <div className="callToAction_BgImage bg-cover object-cover relative flex flex-col max-lg:justify-end lg:flex-row rounded-3xl h-full lg:h-[80%] p-3 sm:p-6 w-full z-20 ">
