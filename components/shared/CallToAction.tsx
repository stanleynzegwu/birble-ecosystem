...
const CallToAction = () => {
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div className="w-full h-screen px-4 py-10 sm:p-10 md:px-20 lg:p-0 max-lg:max-w-xl lg:w-3/4 mx-auto flex flex-col justify-center">
        <div className="relative group flex flex-col max-lg:justify-end lg:flex-row rounded-3xl h-full lg:h-3/4 p-3 sm:p-6 w-full z-20">
          ...
          <div className="p-4 sm:p-6 md:p-8 lg:p-10 h-1/2 w-full lg:w-1/2 lg:h-full rounded-3xl bg-purple-600 flex flex-col justify-end 2xl:justify-center">
            <div className="space-y-4 sm:space-y-8">
              ...
              <Button className="bg-green-200 hover:bg-white text-black capitalize medium rounded-3xl px-6 transition-all duration-300 ease-in-out">
                Sign Up
              </Button>
            </div>
          </div>
